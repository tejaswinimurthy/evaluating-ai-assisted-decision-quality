...
This project evaluates whether a new computer model improves human decision-making compared to an existing model, using evidence from a small-scale A/B test.
